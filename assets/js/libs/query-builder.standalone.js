...
QueryBuilder.OPERATORS = {
    ...
    is_client:        { type: 'is_client',        nb_inputs: 0, multiple: false, apply_to: ['number'] },
    is_not_client:    { type: 'is_not_client',    nb_inputs: 0, multiple: false, apply_to: ['number'] },
    no_sms:           { type: 'no_sms',           nb_inputs: 0, multiple: true,  apply_to: ['number'] },
    sms_in_progress:  { type: 'sms_in_progress',  nb_inputs: 0, multiple: true,  apply_to: ['number'] },
    sms_failed:       { type: 'sms_failed',       nb_inputs: 0, multiple: true,  apply_to: ['number'] },
    sms_received:     { type: 'sms_received',     nb_inputs: 0, multiple: true,  apply_to: ['number'] },
    };
