...
$this->load->view(
    'layout/header',
    [
      'assetsNamespace' => 'Comenzi Primite',
      'pageTitle' => 'Comenzi Primite',
...
<br><br>
  ...
  <div class='col-md-12 text-center'  >
        ...
        ?>
            <a class="btn m-3"  style=" background-color:#FF6347;color:white" href='<?php echo $this->config->item('base_url').'index.php/comenzi/comenzi/'.$comanda->comanda_id ?>' >Comanda numarul: <?= $comanda->comanda_id?></a>
